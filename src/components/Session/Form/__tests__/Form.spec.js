...
describe('<SessionForm/>', () => {
  ...
  it('renders', () => {
    ...
    expect(wrapper.find(SessionStartup).props().nextExercise).to.be.eql(
      firstExercise
    )
  })
  ...
  it('renders rest time per exercise', () => {
    ...
    expect(wrapper.find(SessionExerciseRest).props().nextExercise).to.be.eql(
  ...
  it('renders rest time per round', () => {
    ...
    expect(wrapper.find(SessionRoundRest).props().nextExercise).to.be.eql(
      exercises[0]
    )
    expect(wrapper.find(SessionRoundRest).props().rounds).to.be.equal(rounds)
    expect(wrapper.find(SessionRoundRest).props().roundsCompleted).to.be.equal(
      roundsCompleted
    )
  })
  ...
  it('renders completed session', () => {
    ...
    expect(wrapper.find(SessionCompleted).props().onSubmit).to.be.equal(
      props.onCreateSession
    )
    expect(wrapper.find(SessionCompleted).props().onSubmitFailure).to.be.equal(
      props.onCreateSessionFailure
    )
  })
