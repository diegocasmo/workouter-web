  ...
  return (
    ...
    >
      ...
      <MultistepWizard.Page validationSchema={WorkoutSetupSchema}>
        ...
        <Input
          name="restTimePerRound"
          label="Rest time per round (seconds)"
          placeholder="60"
          type="number"
        />
        <Input
          name="restTimePerExercise"
          label="Rest time per exercise (seconds)"
          placeholder="20"
          type="number"
        />
        ...
        <FieldArray
          ...
          render={({ remove, push, swap, form }) => (
            <>
              ...
              <button
                type="button"
                onClick={() => push(emptyWorkout.exercises[0])}
              >
                Add
              </button>
            </>
