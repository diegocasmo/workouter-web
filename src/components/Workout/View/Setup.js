...
export const WorkoutSetup = ({
  ...
  <div className='wkr-workout-setup'>
    ...
    <ul className='pl-4 list-unstyled'>
      <li className='wrk-workout-setup__workout-name'>Name: {name}</li>
      <li className='wrk-workout-setup__workout-rounds'>Rounds: {rounds}</li>
      <li className='wrk-workout-setup__workout-rest-time-per-round'>
        Rest time per round: {restTimePerRound} {UNITS.SECONDS.text}
      </li>
      <li className='wrk-workout-setup__workout-rest-time-per-exercise'>
