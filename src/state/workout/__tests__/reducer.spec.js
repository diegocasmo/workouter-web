...
describe('Workout Reducer', () => {
  it('should return the initial state', () => {
    expect(workoutReducer(undefined, {})).to.be.eql({
      perPage: 12,
      hasMore: true,
      items: {},
  ...
  describe('FETCH', () => {
    it('FETCH_INIT', () => {
      ...
      expect(workoutReducer(state, action)).to.be.eql({
        ...state,
        items,
    ...
    it('FETCH_SUCCESS', () => {
      ...
      expect(workoutReducer(initialState, action)).to.be.eql(expectedState)
    })
  ...
  describe('GET', () => {
    it('GET_INIT', () => {
      ...
      expect(workoutReducer(initialState, action)).to.be.eql({
        ...initialState,
        status: REQUEST_STATUS.GET,
      })
    })
    ...
    it('GET_SUCCESS', () => {
      ...
      const nextWorkout = Factory.build('workout', {
        ...prevWorkout,
        name: 'new version',
      })
  ...
  describe('DELETE', () => {
    ...
    it('DELETE_SUCCESS', () => {
      ...
      expect(workoutReducer(state, action)).to.be.eql(expectedState)
    })
