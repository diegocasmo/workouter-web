...
describe('Session Reducer', () => {
  it('should return the initial state', () => {
    expect(sessionReducer(undefined, {})).to.be.eql({
      perPage: 12,
      hasMore: true,
      items: {},
  ...
  describe('FETCH', () => {
    it('FETCH_INIT', () => {
      ...
      expect(sessionReducer(state, action)).to.be.eql({
        ...state,
        items,
    ...
    it('FETCH_SUCCESS', () => {
      ...
      expect(sessionReducer(initialState, action)).to.be.eql(expectedState)
    })
  ...
  describe('GET', () => {
    it('GET_INIT', () => {
      ...
      expect(sessionReducer(initialState, action)).to.be.eql({
        ...initialState,
        status: REQUEST_STATUS.GET,
      })
    })
    ...
    it('GET_SUCCESS', () => {
      ...
      const nextSession = Factory.build('session', {
        ...prevSession,
        name: 'new version',
      })
